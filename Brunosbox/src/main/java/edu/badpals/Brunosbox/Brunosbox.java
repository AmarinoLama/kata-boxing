...
import edu.badpals.Brunosbox.Card.ScoreCard;
...
public class Brunosbox
{
    public static void main( String[] args ) {
        ...
        System.out.println("\t FINAL SCORE: " + whiteScoreCard.getRedCornerFinalScore() +
                " - " + whiteScoreCard.getBlueCornerFinalScore() + " FINAL SCORE");
        ...
        */
        ...
        System.out.println("\t FINAL SCORE: " + blueScoreCard.getRedCornerFinalScore() +
                " - " + blueScoreCard.getBlueCornerFinalScore() + " FINAL SCORE");
        ...
        System.out.println("\t FINAL SCORE: " + pinkScoreCard.getRedCornerFinalScore() +
                " - " + pinkScoreCard.getBlueCornerFinalScore() + " FINAL SCORE");

    }
    /* no soy capaz de hacer que cuando se haga un print del scorecard se vea bien */
}